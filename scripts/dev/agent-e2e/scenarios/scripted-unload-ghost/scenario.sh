...
# kill lands before the recording starts and the clip opens on an
# already-unloaded session); not demo-able. claude-unload-load and
# claude-ghost-fleet record the same lifecycle.
#
