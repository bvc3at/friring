...
#
# Demo-able: the mid-step friring-cli/extension calls are one-shot seeding,
# so in demo mode they land before the first frame; F5 records through
# `<leader> w` (SCENARIO_DEMO_KEYS).
#
